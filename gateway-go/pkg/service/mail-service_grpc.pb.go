...
type MailServiceClient interface {
	SendMail(ctx context.Context, in *Mail, opts ...grpc.CallOption) (*SendMailResponse, error)
}
...
type MailServiceServer interface {
	SendMail(context.Context, *Mail) (*SendMailResponse, error)
...
func (UnimplementedMailServiceServer) SendMail(context.Context, *Mail) (*SendMailResponse, error) {
